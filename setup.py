...
#   - the file bigjobasync/VERSION is created with the long_version, und used
...
def get_version():
    ...
    try:
        ...
        open ('%s/bigjobasync/VERSION' % srcroot, 'w').write (long_version+"\n")
...
setup_args = {
    ...
    'description'      : "Asynchronous wrapper around BigJob that implements transparent file transfers and makes heavy use of callbacks and multiprocessing to speed up transfers in the background.",
